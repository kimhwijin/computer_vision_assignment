...
def load_each_paths_to_tensor(image_path, weight_map_path, mask_path):
    return (load_16bit_grayscale_png_image_and_resize_tf(image_path), tf.numpy_function(load_npy_and_resize, [weight_map_path], tf.float32)+1.0), tf.numpy_function(load_npy_and_resize, [mask_path], tf.float32)
